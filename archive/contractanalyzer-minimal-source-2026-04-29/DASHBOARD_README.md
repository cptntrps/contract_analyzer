...
├── uploads/                    # Runtime uploaded contracts
└── test_contracts/            # Sample contracts
```

`reports/`, `uploads/`, report variants, and text extraction backup folders are
runtime/generated data. They are recreated by the dashboard or analyzer and are
not required in the reproducible source set.
